...
export class TweetsComponent implements OnInit {
  ...
  ngOnInit() {
      ...
      this.http.post('http://warm-crag-97295.herokuapp.com/authorize', {headers: headers}).subscribe((res) => {
        console.log(res);
        

        //call  with bearer token to get tweets
        this.http.post('http://warm-crag-97295.herokuapp.com/search', {headers: headers}).subscribe((data) => {
